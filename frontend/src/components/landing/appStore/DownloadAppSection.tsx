                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-2 lg:order-1">
                        <h2 className="text-3xl sm:text-4xl font-bold text-text-primary mb-6">
                            Twój dietetyk zawsze <br className="hidden sm:block"/>
                            <span className="text-primary">w Twojej kieszeni</span>
                        </h2>
                        <p className="text-text-secondary text-lg mb-8 max-w-xl">
                            Pobierz naszą aplikację mobilną i zyskaj natychmiastowy dostęp do swoich planów żywieniowych,
                            listy zakupów i komunikacji z dietetykiem, gdziekolwiek jesteś.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4">
                            {/* Customowy przycisk Google Play pasujący do motywu */}
                            <a
                                href={googlePlayLink}
                                target="_blank"
                            ...
                            >
                                ...
                                <svg className="w-8 h-8 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <path d="M3 20.405V3.596C3 2.677 3.793 2 4.656 2.284L21.19 10.877c0.719 0.373 0.719 1.875 0 2.248L4.656 21.717 C3.793 22.001 3 21.323 3 20.405z"/>
                                </svg>
                                <div className="text-left">
                                    <div className="text-[10px] uppercase font-medium opacity-80 leading-tight">Pobierz z</div>
                        ...
                        <p className="mt-4 text-sm text-text-secondary flex items-center">
                            ...
                            Dostępna dla urządzeń z systemem Android 8.0+
                        </p>
                    </div>

                    {/* Mockup telefonu */}
                    <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
                        <div className="relative max-w-[240px] sm:max-w-[260px] w-full transform rotate-6 hover:rotate-0 transition-transform duration-500 ease-in-out z-10">
                            <MobileMockup/>
                        </div>
                    </div>
                </div>
