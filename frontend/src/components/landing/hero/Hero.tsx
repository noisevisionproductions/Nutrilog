                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-text-secondary text-lg mb-8">
                            ...
                            Oszczędź czas, zwiększ efektywność i rozwijaj swoją praktykę, wybierając najnowocześniejsze
                            rozwiązanie.
                        </p>
                        <NewsletterForm/>
                        <div className="mt-4 flex items-start space-x-2">
                            ...
                            <p className="text-sm text-text-secondary">
                                <span className="font-medium">Oferta specjalna:</span> Pierwszych <span
                                className="font-medium text-primary">50 użytkowników</span> otrzyma 6 miesięcy dostępu
                                za darmo! Zapisz się na listę oczekujących.
                            </p>
                        </div>
                    </motion.div>
