...
class ContactServiceTest {
    ...
    private final String frontendUrl = "https://nutrilog.example.com";
    ...
    void processContactForm_ShouldSaveToFirestoreAndSendEmails() throws ExecutionException, InterruptedException {
        ...
        verify(emailService).sendTemplatedEmail(
                ...
                eq("Dziękujemy za kontakt - NutriLog"),
        ...
        assertEquals("https://nutrilog.example.com/newsletter", userVariables.get("newsletterUrl"));
    }
